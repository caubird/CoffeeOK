...
{
    public partial class CoffeeOK_Control_0322 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (step == 2)//第二步实际执行
            {
                if (DropCup_Flag = true)
                {
                    ...
                    MainTimer.Start();
                    StepJumpControl();
                    //MissionConvertControl();

                    
                }
            }
            if (RobertConnectItem.WorkingConditionFlag && TaskNow.processid != null && TaskNow.processid.Length >= 1 )
            {
                ...
                switch (step)
                {
                    case 1:
                        ...
                        DoMitionOne();
                        //step++;
                        textBox1.Text += "机器人伸手接杯子" + (char)0x0d + (char)0x0a;
                        StepJumpControl();
                    ...
                    case 2:
                        ...
                        RleasACup();
                        Sleep(200);
                        textBox1.Text += "出杯机构出杯" + (char)0x0d + (char)0x0a;
                        ...
                        DoMitionTwo();//接到杯子后继续
                        textBox1.Text += "机器人将杯子拿到咖啡机" + (char)0x0d + (char)0x0a;
                    ...
                    case 3:
                        ...
                        DoMitionThree();
                        textBox1.Text += "点击制作意式咖啡" + (char)0x0d + (char)0x0a;
                        //step++;
                    ...
                    case 4:
                        ...
                        //step++;
                        StepJumpControl();
                        textBox1.Text += "从咖啡机取杯子放到调料位" + (char)0x0d + (char)0x0a;
                    ...
                    case 5:
                        ...
                        textBox1.Text += "把咖啡杯从加调料位置放到出货位置" + (char)0x0d + (char)0x0a;
